...
func SeedRating(tx *sql.Tx, book_id, user_id string, heart_score, poo_score float64) string {
	rating_id := uuid.NewString()
	query := `INSERT INTO ratings (id, book_id, user_id, heart_score, poo_score) VALUES ($1, $2, $3, $4, $5)`
	tx.Exec(query, rating_id, book_id, user_id, heart_score, poo_score)
	return rating_id
}
